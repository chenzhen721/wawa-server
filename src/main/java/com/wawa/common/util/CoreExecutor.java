 ...
 * 核心业务线程池
 */
public class CoreExecutor implements ServletContextListener {
   ...
   private static final String MAX_SIZE = AppProperties.get("buss.thread.maxSize");
    ...
    private static final BaseThreadPoolExecutor EXE =
           new BaseThreadPoolExecutor(Integer.parseInt(MIN_SIZE),
                   Integer.parseInt(MAX_SIZE) ,
                   60L, TimeUnit.SECONDS,
                   new LinkedBlockingQueue<Runnable>(),
                   new CustomizableThreadFactory("CoreExecutor.EXE")) ;
